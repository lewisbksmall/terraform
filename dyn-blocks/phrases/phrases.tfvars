upload_content = [
  ...
  { content = "Get'er Done! (created via our dynamic block)", file = "/terraform/test3.txt", executable = true },
  { content = "Ain't we! (created via our dynamic block)", file = "/terraform/test4.txt", executable = true },
]
